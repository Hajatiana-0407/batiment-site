...
const HeroSection = () => {
  ...
  return (
    <>
      <section id='hero'>
        <div
          className="bg-home flex items-center justify-center px-4 sm:px-10 py-8 sm:py-12"
          style={{
        ...
        >
          <div className="container mx-auto flex flex-col lg:flex-row items-center">
            ...
            <div className="hidden lg:block lg:w-1/2 order-1 lg:order-2 ">
              <div className="w-full  sm:h-64 bg-pic bg-center bg-cover rounded-xl shadow-lg" />
            </div>
          </div>
        </div>
      </section>
