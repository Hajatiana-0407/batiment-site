...
const sidebarItems = [
  { id: 'payments', label: 'Payements', icon: Coins , path: '/payments' },
  // {
  //   id: 'payments',
  //   label: 'Payments',
  //   icon: CreditCard,
  ...
  //   path: '/payments',
  //   subItems: [
  //     { id: 'payments', label: 'Effectués', icon: Coins , path: '/payments' },
  //     { id: 'liste-non-paye', label: 'En attente', icon: Clock, path: '/liste-non-paye' },
  //   ]
  // },
